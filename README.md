...
| :-------------: | :----------: | :--: |  :-----------: | :--------------: | :---------------------: |:---------------------: |
| [TypeForge: Synthesizing and Selecting Best-Fit Composite Data Types for Stripped Binaries](https://noobone123.github.io/papers/typeforge-sp25.pdf) | S&P | 2025 | S | V | [TypeForge](https://github.com/noobone123/TypeForge) | [TypeForge]()
...
| [STRIDE: Simple Type Recognition In Decompiled Executables](https://arxiv.org/pdf/2407.02733) | ArXiv | 2024 | S | V | [STRIDE](https://github.com/hgarrereyn/STRIDE/tree/master) | D | 
